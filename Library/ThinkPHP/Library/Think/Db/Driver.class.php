...
abstract class Driver {
    ...
    public function query($str, $fetchSql=false) {
        ...
        if ( !$this->_linkID ) {
            return array('executed'=>false, 'committed'=>false, 'error'=>'未创建连接',);
        }
        $this->queryStr = $str;
        if(!empty($this->bind)){
            $that   =   $this;
        ...
        if(false === $this->PDOStatement){
            ...
            return array('executed'=>false, 'committed'=>false, 'error'=>$error_message,);
        }
    ...
    public function execute($str,$fetchSql=false) {
        ...
        try{
            ...
            if ( false === $result) {
                ...
                // return $this->numRows;
                // $error_message = $this->error();
                return array('executed'=>true, 'committed'=>true, 'error'=>'', 'numRows'=>$this->numRows, 'lastInsID'=>$this->lastInsID);
            }
        }catch (\PDOException $e) {
            // $this->error();
            // return false;
