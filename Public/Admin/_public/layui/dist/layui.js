...
;!function(t) {
    ...
    r.prototype.use = function(r, o, c, s) {
        ...
        r = function() {
            return "string" == typeof r ? [r] : "function" == typeof r ? (o = r,
            ["all"]) : r
        }(),
...
!function(e, t) {
    ...
    D.prototype.checkDate = function(e) {
        var t, a, n = this, i = (new Date,
        n.config), r = n.lang(), o = i.dateTime = i.dateTime || n.systemDate(), s = n.bindElem || i.elem[0], y = (n.isInput(s) ? "val" : "html",
        function() {
            if (n.rangeElem) {
    ...
    D.prototype.calendar = function(e, t, a) {
        ...
        h && (s.range ? e && (o.listYM = [[s.dateTime.year, s.dateTime.month + 1], [o.endDate.year, o.endDate.month + 1]],
        o.list(s.type, 0).list(s.type, 1),
        "time" === s.type ? o.setBtnStatus("\u65f6\u95f4", lay.extend({}, o.systemDate(), o.startTime), lay.extend({}, o.systemDate(), o.endTime)) : o.setBtnStatus(!0)) : (o.listYM = [[d.year, d.month + 1]],
        o.list(s.type, 0))),
...
layui.define(["lay", "laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    layui.laytpl)
      ...
      , H = function(e) {
        var i = this;
        i.index = ++c.index,
        i.config = t.extend({}, i.config, c.config, e),
        i.render()
    };
    H.prototype.config = {
        limit: 10,
    ...
    H.prototype.render = function() {
        ...
        a.height = I.height() - e.fullHeightGap),
        e.setInit();
        var l = a.elem
          , n = l.next("." + m)
    ...
    H.prototype.eachCols = function(e) {
        var t = this;
        return c.eachCols(null, e, t.config.cols),
        t
    }
    ,
          ...
          , b = function() {
            ...
            return !r && d.sortKey ? d.sort(d.sortKey.field, d.sortKey.sort, !0) : (layui.each(u, function(a, l) {
                var o = []
                  ...
                  , h = []
                  , v = a + s.limit * (n - 1) + 1;
                "array" === layui._typeof(l) && 0 === l.length || (r || (l[c.config.indexName] = a),
                d.eachCols(function(n, r) {
                    var f = r.field || n
                      , m = s.index + "-" + r.key
                      , g = l[f];
            ...
            d.layBody.scrollTop(0),
            d.layMain.find("." + v).remove(),
            d.layMain.find("tbody").html(f.join("")),
            d.layFixLeft.find("tbody").html(m.join("")),
            d.layFixRight.find("tbody").html(g.join("")),
            d.renderForm(),
            "number" == typeof e && d.setThisRowChecked(e),
            d.syncCheckAll(),
            d.haveInit ? d.scrollPatch() : setTimeout(function() {
                d.scrollPatch()
            }, 50),
            d.haveInit = !0,
            l.close(d.tipsIndex),
            s.HAS_SET_COLS_PATCH || d.setColsPatch(),
            void (s.HAS_SET_COLS_PATCH = !0))
        };
        return c.cache[d.key] = u,
        d.layPage[0 == o || 0 === u.length && 1 == n ? "addClass" : "removeClass"](p),
        0 === u.length ? (d.renderForm(),
        d.errorView(s.text.none)) : (d.layFixed.removeClass(p),
        r ? b() : (b(),
        d.renderTotal(u, h),
            ...
            l.eachCols(function(e, d) {
                var c = d.field || e
                  , s = function() {
                    ...
                    return n[c] = i,
                    e = d.totalRow ? y.call(l, d, i, n) || t : t,
                    a ? a[d.field] || e : e
                }()
    ...
    H.prototype.sort = function(e, i, a, l) {
        ...
        "string" == typeof e && (n = e,
        d.layHeader.find("th").each(function(i, a) {
            var l = t(this)
              , o = l.data("field");
            if (o === e)
                return e = l,
        ...
        try {
            var n = n || e.data("field")
              , p = e.data("key");
            if (d.sortKey && !a && n === d.sortKey.field && i === d.sortKey.sort)
                return;
            var v = d.layHeader.find("th .laytable-cell-" + p).find(A);
            d.layHeader.find("th").find(A).removeAttr("lay-sort"),
        ...
        u.autoSort && ("asc" === i ? o = layui.sort(f, n) : "desc" === i ? o = layui.sort(f, n, !0) : (o = layui.sort(f, c.config.indexName),
        delete d.sortKey)),
        s[u.response.dataName] = o || f,
        d.renderData(s, d.page, d.count, !0),
    ...
    H.prototype.syncCheckAll = function() {
        ...
        i[0] && (c.checkStatus(e.key).isAll ? (i[0].checked || (i.prop("checked", !0),
    ...
    H.prototype.fullSize = function() {
        ...
        t.fullHeightGap && (a = I.height() - t.fullHeightGap,
        a < 135 && (a = 135),
        t.elem.css("height", a)),
    ...
    H.prototype.scrollPatch = function() {
        ...
        var r = e.layMain.height()
          , d = r - l;
        e.layFixed.find(C).css("height", i.height() >= d ? d : "auto"),
    ...
    H.prototype.events = function() {
        ...
        i.layBody.on("change", "." + R, function() {
            ...
            var e, a = t(this), l = this, n = a.parent().data("field"), o = a.parents("tr").eq(0).data("index"), r = c.cache[i.key][o];
            i.eachCols(function(t, i) {
    ...
    c.checkStatus = function(e) {
        ...
        return layui.each(l, function(e, l) {
            return "array" === layui._typeof(l) ? void i++ : void (l[c.config.checkName] && (t++,
            a.push(c.clearCacheKey(l))))
        }),
        {
            data: a,
    ...
    c.clearCacheKey = function(e) {
        return e = t.extend({}, e),
        delete e[c.config.checkName],
        delete e[c.config.indexName],
        e
    }
    ,
    t(function() {
